export const TRANSLATIONS = {
  en: {
    ...
    footer: "Made with ♥ for my wife CL and our coming daughter (Nov 2024). | Creator: ",
    creator: "OC",
    ...
    fullscreenTip: "Tip: Press F11 to enter Fullscreen Party Mode!",
    partyNameTitle: "Party Name",
    changeVoteConfirm: "You can only change your vote once. Are you sure?",
    yesChange: "Yes, change",
    cancel: "Cancel",
    revealConfirm: "Are you sure you want to reveal the gender? This cannot be undone.",
    yesReveal: "Yes, reveal",
    ...
    projectInstructions: "🎯 PROJECT THIS PAGE TO YOUR PARTY SCREEN/TV!",
    fullscreenInstructions: "👉 Press F11 for fullscreen party mode",
    husbandJoke: "💡 Don't know how to project? Just let your husband do it! 😄",
    ...
    welcomeMessageOptional: "Optional: Create a personal greeting that guests will see when they join.",
  ...
  zh: {
    ...
    footer: "用 ♥ 製作，獻給我的妻子 CL 和即將出生的女兒 (2024年11月)。| 製作者：",
    creator: "OC",
    ...
    fullscreenTip: "小提示：按 F11 進入全螢幕派對模式！",
    partyNameTitle: "派對名稱",
    changeVoteConfirm: "你只能更改投票一次。確定要更改嗎？",
    yesChange: "是的，更改",
    cancel: "取消",
    revealConfirm: "確定要揭曉性別嗎？此操作無法撤銷。",
    yesReveal: "是的，揭曉",
    ...
    projectInstructions: "🎯 將此頁面投影到派對螢幕/電視！",
    fullscreenInstructions: "👉 按 F11 進入全螢幕派對模式",
    husbandJoke: "💡 不知道怎麼投影？讓老公來處理吧！😄",
    scanToVote: "📱 掃描來報到投票！",
    ...
    welcomeMessageOptional: "選擇性：為賓客創建個人問候語，他們加入時會看到。",
    welcomeMessageCharCount: "字元",
